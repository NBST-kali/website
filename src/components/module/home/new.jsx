...
//         <p className="text-base font-normal text-[#0558EE]">Our Services</p>
//         <h1 className="font-medium text-2xl sm:text-3xl md:text-4xl text-[#050419]">
...
//         <div className=" p-3  flex flex-col gap-5 h-[300px] w-[150px] ">
...
//             deploy software tailored to your specific business needs, ensuring
//             flexibility and scalability for future growth.
//           </p>
//         </div>

//         <div className=" p-3  flex flex-col gap-5 h-[300px] w-[150px] mr-3">
...
//         <div className="p-3  flex flex-col gap-5 h-[300px] w-[312px] mr-3">
//           <h3 className="font-medium text-xl sm:text-2xl mb-12">
//             UI/UX Design
//           </h3>
//           <p className="font-normal text-sm sm:text-base text-gray-700">
//             Our design experts craft user-friendly interfaces that enhance user
//             engagement and deliver intuitive experiences across all devices.
//           </p>
//         </div>
...
//             seamless user experience, tailored to your specific business needs.
//           </p>
//         </div>
...
//         <div className=" p-3  flex flex-col gap-5 h-[300px] w-[312px]">
//           <h3 className="font-medium text-xl sm:text-2xl mb-10">
